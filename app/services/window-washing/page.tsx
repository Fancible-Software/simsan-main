...
export default function WindowWashingPage() {
  ...
  const faqItems = [
    ...
    },
    {
      ...
      answer: "Absolutely. Water-fed poles allow us to safely clean second-, third- and multi-story windows without ladders, making it ideal for homes and commercial buildings throughout the Lower Mainland, Fraser Valley and Vancouver Island areas."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes. We provide residential and commercial window cleaning services for offices, retail spaces, strata buildings and more across Lower Mainland, Fraser Valley and Vancouver Island areas."
    },
    {
